...
4. **コミットとマージ**
    作成したコードをgithubにコミットする⇒これはvscodeの拡張機能を使用してもOK,gitbashでコマンド叩いてもいい
    MR作成後に相手にコードレビュー依頼
...
※改修予定
- [画面遷移図](https://drive.google.com/drive/u/0/folders/1j4_SbTqlli22A3w5fTNJ0uVW9QkxbxbU)
- [画面詳細図](https://drive.google.com/drive/u/0/folders/1j4_SbTqlli22A3w5fTNJ0uVW9QkxbxbU)
